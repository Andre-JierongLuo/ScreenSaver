...
public class Main {
	...
	public static final Shape triangle = new Polygon(new int[] {-20,0,20},
			new int[] {10,-20,10}, 3);
	public static final Shape doubleTriangle = new Polygon(new int[] {-25,25,-25,25},
			new int[] {-20,20,20,-20},4);
